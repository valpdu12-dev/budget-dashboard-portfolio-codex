...
export function makeConfig(overrides: Partial<Config> = {}): Config {
  return {
    ...
    transfers: ["Transfert Horizon vers Équilibre", "Transfert Horizon vers Nova"],
    comptes: ["Banque Horizon - Courant", "Banque Nova - Compte joint", "Banque Équilibre - Compte joint", "Carte repas - Titres restaurant"],
    primaryLinkedAccounts: ["Banque Horizon - Courant"],
    colors: {},
    ...overrides,
  };
}
...
export function makeTransferTx(overrides: Partial<Transaction> = {}): Transaction {
  return makeTx({
    type: "Transfert Horizon vers Équilibre",
    cat1: "",
    cat2: "",
    montant: 500,
    ...overrides,
