...
const TRANSFERTS = new Set(["Transfert Horizon vers Équilibre", "Transfert Horizon vers Nova"]);
...
describe("comparaison N / N-1 sur période équivalente", () => {
  ...
  it("exclut les virements internes DES DEUX CÔTÉS", () => {
    const courantes = [dep("2026-01-10", 100), dep("2026-01-11", 900, "Transfert Horizon vers Équilibre")];
    const toutes = [...courantes, dep("2025-01-10", 100), dep("2025-01-11", 900, "Transfert Horizon vers Équilibre")];
