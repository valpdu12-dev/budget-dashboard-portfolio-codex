...
Cœur de l'application React. Les données fictives viennent de fichiers JSON statiques ; elles sont chargées dans des stores Zustand, dérivées par des hooks, puis affichées par les pages.
...
| `App.tsx` | Composant racine — orchestre le chargement des données statiques et le layout |
